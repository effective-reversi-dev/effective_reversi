...
- Create a copy of ``reversi/settings/local.py.example``:  
  `cp reversi/settings/local.py.example reversi/settings/local.py` (remembering you should replace `reversi` with your project's name!).
