...
describe('testing Chat', () => {
    const userName = 'test user',
        ...
        setupComponent = (props) => {
            ...
            return Object.assign({}, renderWithRedux(<GameChatContainer {...props} />, { initialState }))
        }
    ...
    test('should send a message and should not close WebSocket after submitting it', () => {
        const props = { chatInfo, onSendChatInfo: jest.fn(), closeChatSocket: jest.fn() },
            { getByText, getByPlaceholderText } = render(<GameChatComponent {...props} />)
        fireEvent.change(getByPlaceholderText('Input message...'), { target: { value: message } });
