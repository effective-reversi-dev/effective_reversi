...
import { all, call, fork, put, take, takeEvery, cancel, select } from 'redux-saga/effects';
...
const webSocketSagas = () => {
    ...
    const keyValList = Object.keys(webSocketMap).map(wsSetupAction => [wsSetupAction, webSocketMap[wsSetupAction]]);
    let wsSagas = [];
